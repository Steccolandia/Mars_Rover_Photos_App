...
import com.steccos.marsroverapp.domain.model.RoverManifestUiModel
...
@Composable
fun ManifestPreview() {
    Manifest(roverManifestUiModel = RoverManifestUiModel(sol = "4", earthDate = "2021-03-05", photoNumber =  "34"),
    roverName = "," ,
    onClick = {_ , _ ->}
    )
}